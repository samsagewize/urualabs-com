...
const rooms: Room[] = [
  {
    id: "office",
    name: "Kirbo's CEO Office",
    emoji: "🤖",
    description: "Where Magnemite runs the company!",
    background: "from-cyan-900 to-blue-900",
    decorations: ["🖥️", "📊", "💼", "📞", "🖨️", "📁", "🗂️", "🔋", "⚡", "🔌", "💡", "📈"],
  },
  {
    id: "studio",
    name: "Kitty's Creative Studio",
    emoji: "🎨",
    description: "Where Kitty the Meowth creates amazing art!",
    background: "from-purple-900 to-pink-900",
    decorations: ["🎨", "🖌️", "🖼️", "🎭", "🎪", "🎢", "🎡", "🎠", "🖌️", "🎨", "📐", "✏️", "🖍️", "📏"],
  },
  {
    id: "marketing",
    name: "Ralph's Marketing Den",
    emoji: "🦊",
    description: "Where Ninetales plots marketing magic!",
    background: "from-orange-900 to-red-900",
    decorations: ["📧", "📊", "📢", "🎯", "📑", "📋", "📱", "🌐", "🔥", "💬", "📣", "⭐"],
  },
  {
    id: "music",
    name: "Max's Music Studio",
    emoji: "🎵",
    description: "Where Meloetta finds music grants!",
